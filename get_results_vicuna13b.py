...
def run_inference(dataset, method, stratified, num_examples):
    ...
    if dataset == "forget":
        ...
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_0_random.txt", "wb") as data:   #Pickling
        ...
        with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_0_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data) 
        ...
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_0_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data) 
    ...
    if dataset == "film":
        ...
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_1_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 5 )
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_5_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        ...
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_10_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        ...
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_20_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        ...
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 5)
        with open("formal_eva_results_vicuna13b/thf_stratified_input_30_example_5_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data) 
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 10)
        with open("formal_eva_results_vicuna13b/thf_stratified_input_30_example_10_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data) 
        # num_examples = 20  
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 20)
        with open("formal_eva_results_vicuna13b/thf_stratified_input_30_example_20_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data) 
        ...
        # num_examples = 1
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 1 )
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_1_sentence.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)  
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 5 )
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_5_sentence.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 10 )
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_10_sentence.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 20 )
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_20_sentence.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        ...
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 5)
        with open("formal_eva_results_vicuna13b/thf_stratified_input_30_example_5_sentence.txt", "wb") as data:   #Pickling
            pickle.dump(response, data) 
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 10)
        with open("formal_eva_results_vicuna13b/thf_stratified_input_30_example_10_sentence.txt", "wb") as data:   #Pickling
            pickle.dump(response, data) 
        # num_examples = 20  
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 20)
        with open("formal_eva_results_vicuna13b/thf_stratified_input_30_example_20_sentence.txt", "wb") as data:   #Pickling
            pickle.dump(response, data) 
        ...
        # num_examples = 1
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 1 )
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_1_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)       
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 5 )
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_5_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 10 )
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_10_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 20 )
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_20_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        ...
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 5 )
        with open("formal_eva_results_vicuna13b/thf_stratified_input_30_example_5_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 10 )
        with open("formal_eva_results_vicuna13b/thf_stratified_input_30_example_10_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 20 )
        with open("formal_eva_results_vicuna13b/thf_stratified_input_30_example_20_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        ...
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 5 )
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_5_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 10 )
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_10_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 20 )
        with open("formal_eva_results_vicuna13b/thf_not_stratified_input_30_example_20_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        ...
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 5 )
        with open("formal_eva_results_vicuna13b/thf_stratified_input_30_example_5_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 10 )
        with open("formal_eva_results_vicuna13b/thf_stratified_input_30_example_10_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "film", num_examples = 20 )
        with open("formal_eva_results_vicuna13b/thf_stratified_input_30_example_20_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)        
...
#         with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_1_random.txt", "wb") as data:   #Pickling
#             pickle.dump(response, data)
#         # num_examples = 5
...
#         with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_5_random.txt", "wb") as data:   #Pickling
#             pickle.dump(response, data)   
#         # num_examples = 10
...
#         with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_10_random.txt", "wb") as data:   #Pickling
#             pickle.dump(response, data)
#         # num_examples = 20
...
#         with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_20_random.txt", "wb") as data:   #Pickling
#             pickle.dump(response, data)
...
#         # num_examples = 5
#         prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 5)
#         with open("formal_eva_results_vicuna13b/assembly_stratified_input_30_example_5_random.txt", "wb") as data:   #Pickling
#             pickle.dump(response, data) 
#         # num_examples = 10
#         prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 10)
#         with open("formal_eva_results_vicuna13b/assembly_stratified_input_30_example_10_random.txt", "wb") as data:   #Pickling
#             pickle.dump(response, data) 
#         # num_examples = 20  
#         prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 20)
#         with open("formal_eva_results_vicuna13b/assembly_stratified_input_30_example_20_random.txt", "wb") as data:   #Pickling
#             pickle.dump(response, data) 
...
#         # num_examples = 1
#         prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 1 )
#         with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_1_sentence.txt", "wb") as data:   #Pickling
#             pickle.dump(response, data)  
#         # num_examples = 5
#         prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 5 )
#         with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_5_sentence.txt", "wb") as data:   #Pickling
#             pickle.dump(response, data)   
#         # num_examples = 10
#         prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 10 )
#         with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_10_sentence.txt", "wb") as data:   #Pickling
#             pickle.dump(response, data)
#         # num_examples = 20
#         prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 20 )
#         with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_20_sentence.txt", "wb") as data:   #Pickling
#             pickle.dump(response, data)
...
#         # num_examples = 5
#         prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 5)
#         with open("formal_eva_results_vicuna13b/assembly_stratified_input_30_example_5_sentence.txt", "wb") as data:   #Pickling
#             pickle.dump(response, data) 
#         # num_examples = 10
#         prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 10)
#         with open("formal_eva_results_vicuna13b/assembly_stratified_input_30_example_10_sentence.txt", "wb") as data:   #Pickling
#             pickle.dump(response, data) 
#         # num_examples = 20  
#         prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 20)
#         with open("formal_eva_results_vicuna13b/assembly_stratified_input_30_example_20_sentence.txt", "wb") as data:   #Pickling
#             pickle.dump(response, data) 
...
#    if stratified == "false":
        ...
        # num_examples = 1
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 1 )
        with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_1_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)    
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 5 )
        with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_5_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 10 )
        with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_10_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 20 )
        with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_20_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
...
#    else: # stratified == True
        ...
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 5 )
        with open("formal_eva_results_vicuna13b/assembly_stratified_input_30_example_5_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 10 )
        with open("formal_eva_results_vicuna13b/assembly_stratified_input_30_example_10_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 20 )
        with open("formal_eva_results_vicuna13b/assembly_stratified_input_30_example_20_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
...
#    if stratified == "false":
        ...
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 5 )
        with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_5_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 10 )
        with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_10_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 20 )
        with open("formal_eva_results_vicuna13b/assembly_not_stratified_input_30_example_20_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
...
#    else: # stratified == True
        ...
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 5 )
        with open("formal_eva_results_vicuna13b/assembly_stratified_input_30_example_5_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 10 )
        with open("formal_eva_results_vicuna13b/assembly_stratified_input_30_example_10_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "assembly", num_examples = 20 )
        with open("formal_eva_results_vicuna13b/assembly_stratified_input_30_example_20_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)        
#else: ## 'random', 'sentence', 'tfidf', 'tfidf_half'.
#    raise  ValueError ("You can only select dataset between 'random', 'sentence', 'tfidf', 'tfidf_half'." )
...
#    if stratified ==  "false":
        ...
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_1_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)    
        # num_examples = 5
        ...
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_5_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        ...
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_10_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        ...
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_20_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
...
#    else: # stratified == True
        ...
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 5)
        with open("formal_eva_results_vicuna13b/fabner_stratified_input_30_example_5_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data) 
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 10)
        with open("formal_eva_results_vicuna13b/fabner_stratified_input_30_example_10_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data) 
        # num_examples = 20  
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 20)
        with open("formal_eva_results_vicuna13b/fabner_stratified_input_30_example_20_random.txt", "wb") as data:   #Pickling
            pickle.dump(response, data) 
...
#    if stratified ==  "false":
        ...
        # num_examples = 1
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 1 )
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_1_sentence.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)    
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 5 )
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_5_sentence.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 10 )
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_10_sentence.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 20 )
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_20_sentence.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
...
#    else: # stratified == True
        ...
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 5)
        with open("formal_eva_results_vicuna13b/fabner_stratified_input_30_example_5_sentence.txt", "wb") as data:   #Pickling
            pickle.dump(response, data) 
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 10)
        with open("formal_eva_results_vicuna13b/fabner_stratified_input_30_example_10_sentence.txt", "wb") as data:   #Pickling
            pickle.dump(response, data) 
        # num_examples = 20  
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 20)
        with open("formal_eva_results_vicuna13b/fabner_stratified_input_30_example_20_sentence.txt", "wb") as data:   #Pickling
            pickle.dump(response, data) 
...
#    if stratified == "false":
        ...
        # num_examples = 1
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 1 )
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_1_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)    
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 5 )
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_5_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 10 )
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_10_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 20 )
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_20_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
...
#    else: # stratified == True
        ...
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 5 )
        with open("formal_eva_results_vicuna13b/fabner_stratified_input_30_example_5_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 10 )
        with open("formal_eva_results_vicuna13b/fabner_stratified_input_30_example_10_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 20 )
        with open("formal_eva_results_vicuna13b/fabner_stratified_input_30_example_20_tfidf.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
...
#    if stratified == "false":
        ...
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 5 )
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_5_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 10 )
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_10_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 20 )
        with open("formal_eva_results_vicuna13b/fabner_not_stratified_input_30_example_20_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
...
#    else: # stratified == True
        ...
        # num_examples = 5
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 5 )
        with open("formal_eva_results_vicuna13b/fabner_stratified_input_30_example_5_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)   
        # num_examples = 10
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 10 )
        with open("formal_eva_results_vicuna13b/fabner_stratified_input_30_example_10_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)
        # num_examples = 20
        prompt_text , response = get_direct_gpt_response(all_fewshot_sen, all_fewshot_dem, sentences_input, dataset = "fabner", num_examples = 20 )
        with open("formal_eva_results_vicuna13b/fabner_stratified_input_30_example_20_tfidf_half.txt", "wb") as data:   #Pickling
            pickle.dump(response, data)        
#else: ## 'random', 'sentence', 'tfidf', 'tfidf_half'.
    #raise  ValueError ("You can only select dataset between 'random', 'sentence', 'tfidf', 'tfidf_half'." )
    else:
