...
eval_before, eval_after = transformer_finetune_ner_downstream(
        ...
        ### thin-film head dataset
        # train_file = ("./salmon/data_finetuning/finetune_bert_based_entity_model_thf/formal_thf_train.jsonl"),
        # val_file = ("./salmon/data_finetuning/finetune_bert_based_entity_model_thf/formal_thf_val_test.jsonl"),
        # test_file = ("./salmon/data_finetuning/finetune_bert_based_entity_model_thf/formal_thf_val.jsonl"),

        ### assembly instruction
        # train_file = ("./salmon/data_finetuning/finetune_bert_based_entity_model_assembly/formal_assembly_train.jsonl"),
        # val_file = ("./salmon/data_finetuning/finetune_bert_based_entity_model_assembly/formal_assembly_val_test.jsonl"),
        # test_file = ("./salmon/data_finetuning/finetune_bert_based_entity_model_assembly/formal_assembly_val.jsonl"),

        ### FabNER manufacturing
        train_file = ("./salmon/data_finetuning/finetune_bert_based_entity_model_fabner/fabner_train_finetune.jsonl"),
        val_file = ("./salmon/data_finetuning/finetune_bert_based_entity_model_fabner/fabner_val_finetune.jsonl"),
        test_file = ("./salmon/data_finetuning/finetune_bert_based_entity_model_fabner/fabner_test_finetune.jsonl"),

        #base_model='models/cli_lm_test_pythonapi',
        base_model= "bert-base-uncased", # 'distilroberta-base',
        #output_model='formal_models_finetuned_film',
        #output_model='formal_models_finetuned_assembly',
        output_model='formal_models_finetuned_fabner',
